...
public class ReflectUtilTest {
    private static Logger log = LoggerFactory.getLogger(ReflectUtilTest.class);
    ...
    public void testFindFields() throws Exception {
        ...
        Field[] fields = ReflectUtil.getAccessibleFields(User.class);
    ...
    public void testFindMethods() throws Exception {
        Method[] methods = ReflectUtil.getAccessibleMethods(User.class);
