...
public class JsonUtilTest {
    ...
    public void init() {
        ...
        jsonString1 = JsonUtil.toJsonString(data1);
        jsonString2 = JsonUtil.toJsonString(data2);
    }

    @Test
    public void test0() {
        log.info(JsonUtil.toJsonString(data));
        log.info(JsonUtil.toJsonString(data1));
        log.info(JsonUtil.toJsonString(data2));
    }
    ...
    @Test
    public void test2() {
        List<User> list = JsonUtil.parseObject(jsonString1
    ...
    @Test
    public void test3() {
        Map<Long, User> map = JsonUtil.parseObject(jsonString2
