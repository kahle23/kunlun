...
public class ChainServiceTest {
    ...
    static {
        ...
        ChainUtil.registerNode("node1", new ChainNode() {
            @Override
        ...
        ChainUtil.registerNode("node2", new ChainNode() {
            @Override
            public void execute(Context context) {
                Object data = context.getResult() != null ? context.getResult() : context.getArguments()[1];
        ...
        ChainUtil.registerNode("node3", new ChainNode() {
            @Override
            public void execute(Context context) {
                Object data = context.getResult() != null ? context.getResult() : context.getArguments()[1];
    ...
    @Test
    public void test1() {
        Number result = ChainUtil.execute(chainId, 1, Number.class);
