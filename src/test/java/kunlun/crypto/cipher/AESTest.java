...
public class AESTest extends BouncyCastleSupport {
    ...
    public void testEcbZeroPadding() {
        ...
        testEncryptAndDecrypt("AES/ECB/ZeroPadding", FALSE);
    }

    @Test
    public void testEcbPKCS5Padding() {

        testEncryptAndDecrypt("AES/ECB/PKCS5Padding", FALSE);
    }

    @Test
    public void testCbcZeroPadding() {

        testEncryptAndDecrypt("AES/CBC/ZeroPadding", TRUE);
    }

    @Test
    public void testCbcPKCS5Padding() {

        testEncryptAndDecrypt("AES/CBC/PKCS5Padding", TRUE);
    }
