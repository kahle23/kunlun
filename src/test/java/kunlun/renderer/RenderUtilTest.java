...
public class RenderUtilTest {
    private static final Logger log = LoggerFactory.getLogger(RenderUtilTest.class);
    private static final String rendererName = "default";

    @Test
    public void test1() {
        String render = RenderUtil.renderToString(rendererName, "Hello, ${arg}!"
                , Dict.of("arg", "World"));
        log.info(render);
        assertEquals(render, "Hello, World!");

        render = RenderUtil.renderToString(rendererName, "Hello, \\\\${arg}!"
                , Dict.of("arg", "World"));
        log.info(render);
        assertEquals(render, "Hello, \\\\World!");

        render = RenderUtil.renderToString(rendererName, "Hello, ${arg}! ${arg1}"
                , Dict.of("arg", "World").set("arg1", "Hi"));
        log.info(render);
        assertEquals(render, "Hello, World! Hi");

        render = RenderUtil.renderToString(rendererName, "Hello, \\${arg}, \\\\${arg1}, ${arg2}! "
