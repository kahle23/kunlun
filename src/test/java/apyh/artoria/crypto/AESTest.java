...
public class AESTest {
    ...
    public void test1() throws Exception {
        ...
        AES aes = AES.create(AES.ECB_PKCS_5_PADDING, key);
        ...
        AES aes1 = AES.create(AES.CBC_PKCS_5_PADDING, key).setIv(iv);
    ...
    public void test2() throws Exception {
        ...
        System.out.println("key = " + new String(key));
        System.out.println("iv = " + new String(iv));
        AES aes = AES.create(AES.ECB_NO_PADDING, key);
        byte[] bytes = aes.encrypt("你好，Java！1");
        System.out.println(Base64.encodeToString(bytes));
        System.out.println(new String(aes.decrypt(bytes)));
        AES aes1 = AES.create(AES.CBC_NO_PADDING, key).setIv(iv);
