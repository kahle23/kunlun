...
public class HashTest {
    ...
    public void hashFile() throws Exception {
        ...
        log.info(hex.encodeToString(md5.digest(testFile)));
        log.info(hex.encodeToString(sha1.digest(testFile)));
        log.info(hex.encodeToString(sha256.digest(testFile)));
        log.info(hex.encodeToString(sha384.digest(testFile)));
        log.info(hex.encodeToString(sha512.digest(testFile)));
    }
