...
public class UnicodeUtilsTest {
    private static Logger log = LoggerFactory.getLogger(UnicodeUtilsTest.class);

    @Test
    public void test1() {
        String encode = UnicodeUtils.encode("Hello，Java! ");
        log.info(encode);
        log.info(UnicodeUtils.decode(encode));
    }
    ...
    public void test2() {
        ...
        log.info(UnicodeUtils.decode(data));
    }
