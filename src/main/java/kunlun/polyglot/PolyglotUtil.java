...
public class PolyglotUtil {
    private static final Logger log = LoggerFactory.getLogger(PolyglotUtil.class);
    ...
    public static PolyglotService getPolyglotService() {
        ...
        synchronized (PolyglotUtil.class) {
            if (polyglotService != null) { return polyglotService; }
            PolyglotUtil.setPolyglotService(new ScriptEngineService());
    ...
    public static void setPolyglotService(PolyglotService polyglotService) {
        ...
        PolyglotUtil.polyglotService = polyglotService;
    }
