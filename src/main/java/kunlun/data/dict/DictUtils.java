...
public class DictUtils {
    ...
    public static Dict getByCondition(DictQuery dictQuery) {

        return getDictService().getByCondition(dictQuery);
    }
    ...
    public static Collection<Dict> listByCondition(DictQuery dictQuery, Type type) {

        return getDictService().listByCondition(dictQuery, type);
    }
