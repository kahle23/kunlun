...
package kunlun.action.support.ai;
 ...
 */
@Deprecated
public abstract class AbstractScriptBasedAiInvokeHandler extends AbstractInvokeActionHandler {
    private static final Logger log = LoggerFactory.getLogger(AbstractScriptBasedAiInvokeHandler.class);
